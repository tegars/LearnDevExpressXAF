...
namespace LearnXAF.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class LearnXAFAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private LearnXAF.Module.LearnXAFModule module3;
        private LearnXAF.Module.Web.LearnXAFAspNetModule module4;

        public LearnXAFAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void LearnXAFAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new LearnXAF.Module.Web.LearnXAFAspNetModule();
            ((System.ComponentModel.ISupportInitialize)(this)).BeginInit();
            // 
            // LearnXAFAspNetApplication
            // 
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.LearnXAFAspNetApplication_DatabaseVersionMismatch);
